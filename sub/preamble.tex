...
%:                  논문 제목과 저자 이름을 입력하시오
% ----------------------------------------------------------------------
\title{단결정 페로브스카이트의 PL측정을 통한 waveguiding effect의 원인분석} %한글 제목
\engtitle{Analysis of the cause of waveguiding effect by PL measurement of single crystal perovskite} %영문 제목
